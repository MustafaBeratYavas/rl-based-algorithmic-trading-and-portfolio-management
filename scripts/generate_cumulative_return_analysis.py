"""Render the 1920x1080 cumulative portfolio return analysis chart."""
...
from src.evaluation.portfolio_research_charts import (
    ...
    save_cumulative_return_analysis,
)
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Generate a PPO/SPY/equal-weight cumulative return analysis chart."
    )
    ...
    parser.add_argument("--file-name", default="cumulative_portfolio_return_analysis.png")
...
def main() -> None:
    ...
    try:
        ...
        chart_path = save_cumulative_return_analysis(
            trace,
            output_path,
            width=args.width,
            height=args.height,
